package com.image.swiperefresh;
...
import com.image.swiperefresh.refresh_view.BaseRefreshView;
import com.image.swiperefresh.refresh_view.SunRefreshView;
...
public class PullToRefreshView extends ViewGroup
{
    ...
    public PullToRefreshView(Context context, AttributeSet attrs)
    {
        ...
        final int type = a.getInteger(R.styleable.PullToRefreshView_type, STYLE_SUN);
        final int sun = a.getResourceId(R.styleable.PullToRefreshView_refresh_sun, 0);
        final int sky = a.getResourceId(R.styleable.PullToRefreshView_refresh_sky, 0);
        final int building = a.getResourceId(R.styleable.PullToRefreshView_refresh_building, 0);
        a.recycle();
        ...
        setRefreshStyle(type, sun, sky, building);
    ...
    public void setRefreshStyle(int type, int sun, int sky, int building)
    {
        setRefreshing(false);
        switch (type)
        {
            case STYLE_SUN:
                mBaseRefreshView = new SunRefreshView(getContext(), this, sun, sky, building);
                break;
            default:
