...
import com.tysci.ballq.activitys.BqErrorActivity;
...
public final class CustomActivityOnCrash
{
    ...
    public static final String EXTRA_RESTART_ACTIVITY_CLASS = "com.tysci.ballq.EXTRA_RESTART_ACTIVITY_CLASS";
    public static final String EXTRA_SHOW_ERROR_DETAILS = "com.tysci.ballq.EXTRA_SHOW_ERROR_DETAILS";
    public static final String EXTRA_STACK_TRACE = "com.tysci.ballq.EXTRA_STACK_TRACE";
    //    private static final String EXTRA_IMAGE_DRAWABLE_ID = "com.tysci.ballq.EXTRA_IMAGE_DRAWABLE_ID";
    private static final String EXTRA_EVENT_LISTENER = "com.tysci.ballq.EXTRA_EVENT_LISTENER";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.tysci.ballq.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.tysci.ballq.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.tysci.ballq";
                            ...
                            else
                            {
                                ...
                                else if (launchErrorActivityWhenInBackground || !isInBackground)
                                {
                                    ...
                                    if (throwable instanceof Exception)
                                        PgyCrashManager.reportCaughtException(application, (Exception) throwable);

                                    intent.putExtra(EXTRA_STACK_TRACE, stackTraceString);
                                    intent.putExtra(EXTRA_RESTART_ACTIVITY_CLASS, restartActivityClass);
                                    intent.putExtra(EXTRA_SHOW_ERROR_DETAILS, throwable.toString());
...
//    }
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.tysci.ballq.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.tysci.ballq.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.tysci.ballq.ERROR" />,
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context)
    {
        ...
        if (resolvedActivityClass == null)
        {
            resolvedActivityClass = BqErrorActivity.class;
        }
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.tysci.ballq.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
