...
//    private LoadingProgressDialog loadingProgressDialog = null;
    ...
    {
        String url = HttpUrls.CIRCLE_HOST_URL_V2 + "bbs/topic/view/" + id;
        ...
        if (UserInfoUtil.checkLogin(this))
        {
            ...
            params.put("topicId", String.valueOf(id));
        }
...
//                startActivity(intent);
    ...
    {
        String url = HttpUrls.CIRCLE_HOST_URL_V1 + "bbs/topic/" + id
    ...
    {
        String url = HttpUrls.CIRCLE_HOST_URL_V2 + "bbs/topic/islike/" + id;
    ...
    {
        KLog.e("检查是否收藏...");
        String url = HttpUrls.CIRCLE_HOST_URL_V2 + "bbs/topic/iscollect/" + id;
        HashMap<String, String> params = new HashMap<>(1);
        params.put("userId", UserInfoUtil.getUserId(this));
        params.put("token", UserInfoUtil.getUserToken(this));
        params.put("topicId", String.valueOf(id));
    ...
    private void userLike(int id)
    {
        ...
        {
            String url = HttpUrls.CIRCLE_HOST_URL_V2 + "bbs/topic/like/" + id;
    ...
    private void userComment()
    {
        ...
        else
        {
            ...
            String url = HttpUrls.CIRCLE_HOST_URL_V2 + "bbs/topic/" + noteId
                    + "/comment/add/";
