 ...
 * on 2016-08-03 0003.
 */
public class UserOldTrendStatisticActivity extends BaseActivity
{
    ...
    protected void initViews()
    {
        ...
        layoutFooterBallTrend.setVisibility(View.GONE);
        layoutBasketBallTrend.setVisibility(View.GONE);
    }
    ...
    {
        String url = HttpUrls.HOST_URL_V5 + "old/user/" + uid + "/profile/";
            ...
            public void onSuccess(Call call, String response)
            {
                ...
                if (!TextUtils.isEmpty(response))
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        {
                            GlideImageLoader.loadImage(UserOldTrendStatisticActivity.this, dataObj.getString("pt"), R.mipmap.icon_user_default, ivUserIcon);
