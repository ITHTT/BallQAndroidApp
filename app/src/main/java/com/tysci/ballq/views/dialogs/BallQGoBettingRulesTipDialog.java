 ...
 */
public class BallQGoBettingRulesTipDialog extends Dialog implements View.OnClickListener{
    private Window window;
    private Context context;
    private View view;

    public BallQGoBettingRulesTipDialog(Context context) {
    ...
    private void initViews(Context context) {
        view = LayoutInflater.from(context).inflate(R.layout.dialog_ballq_go_betting_rules, null);
