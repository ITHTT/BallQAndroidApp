 ...
 */
public class BallQUserRewardRankingRulesTipDialog extends Dialog implements View.OnClickListener{
    private Window window;
    private Context context;
    private View view;

    public BallQUserRewardRankingRulesTipDialog(Context context) {
    ...
    private void initViews(Context context) {
        view = LayoutInflater.from(context).inflate(R.layout.dialog_user_reward_rank_rules_tip, null);
