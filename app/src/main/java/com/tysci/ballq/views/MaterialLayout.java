 ...
 *
 * @author MaterialLayout是模拟Android 5.0中View被点击的波纹效果的布局，与其他的模拟Material
 *         Desigin效果的View不同，所有在MaterialLayout布局下的子视图被点击时都会产生波纹效果,而不是某个特定的View
 */
public final class MaterialLayout extends RelativeLayout
{
    ...
    private void initTypedArray(Context context, AttributeSet attrs)
    {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_material_color, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout_material_duration,
                DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.MaterialLayout_material_framerate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_material_alpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.MaterialLayout_material_scale, DEFAULT_SCALE);
